<template>
  <div class="image">
    <div class="waterfall">
      <div class="column" v-for="(item, index) in imageList" :key="index">
        <div class="column-item" v-for="(image, indexs) in item" :key="indexs">
          <img
            class="img"
            :src="
              'https://francisxu.github.io/waterfall-flow/images/' + image.url
            "
            alt=""
          />
  ...
  methods: {
    ...
    pushImage(index) {
      ...
      let img = new Image(),
        that = this;
      img.src =
        "https://francisxu.github.io/waterfall-flow/images/" +
        that.tempImage[index].url;
      img.onload = () => {
        let min = that.imageHeight[0],
          imageIndex = 0;
        ...
        that.imageHeight[imageIndex] +=
          img.naturalHeight / img.naturalWidth + 96 / that.imageWidth;
